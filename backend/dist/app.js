...
/***/ function(module, exports, __webpack_require__) {
	...
	var serveClient = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var express = __webpack_require__(1);
	var userRouter = __webpack_require__(3);
	var gameRouter = __webpack_require__(11);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function register(req, res, next) {
	    ...
	    if (!username || !password) {
	        ...
	        User.register(username, password).then(function (user) {
	            ...
	            return next(ERRORS.REGISTRATION_FAILED(err));
	        });
	    }
	}
	...
	function authenticate(req, res, next) {
	    ...
	    if (!authorize) {
	        return next(ERRORS.WRONG_CREDENTIALS());
	    }
	    ...
	    User.login(req.query.username, password[1]).then(function (user) {
	        res.status(200);
	        res.json({
	            token: utils.genToken(user.id)
	        });
...
/***/ function(module, exports) {
	...
	exports.MISSING_PARAMETERS = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var mongo = __webpack_require__(6);
	var utils = __webpack_require__(9);
	...
	function findUserByName(username) {
	    ...
	    return mongo.connect().then(function (db) {
	        return db.collection('users').findOne({ username: username }).then(mongo.close(db));
	    }).then(function (user) {
	        if (user == null) {
	...
	function userExists(username) {
	    ...
	    return findUserByName(username).then(function () {
	...
	function saveUser(user) {
	    ...
	    return mongo.connect().then(function (db) {
	        return db.collection('users').insertOne(user).then(mongo.close(db));
	    }).then(function () {
	        return user;
	    });
	}
	...
	exports.register = function register(username, password) {
	    return ensureParams(username, password).then(function () {
	        return userExists(username);
	    }).then(function (exist) {
	        return exist ? Promise.reject(exports.ERR_ALREADY_EXISTS) : Promise.resolve(createUser(username, password));
	    }).then(saveUser);
	};
	...
	exports.login = function login(username, password) {
	    ...
	    return findUserByName(username).then(function (user) {
...
/***/ function(module, exports) {
	...
	var DB_USERNAME = process.env.OPENSHIFT_MONGODB_DB_USERNAME;
	var DB_PASSWORD = process.env.OPENSHIFT_MONGODB_DB_PASSWORD;
	var DB_NAME = "hexode";
	var DB_URL = "mongodb://" + (DB_USERNAME ? DB_USERNAME + ":" + DB_PASSWORD + "@" : "") + DB_HOST + ":" + DB_PORT + "/" + DB_NAME;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.readToken = function readToken(token) {
	    ...
	    var _plaintext$split = plaintext.split('|');

	    var _plaintext$split2 = _slicedToArray(_plaintext$split, 2);

	    var data = _plaintext$split2[0];
	    var expiration = _plaintext$split2[1];
...
/***/ function(module, exports, __webpack_require__) {
	...
	function create(req, res, next) {
	    ...
	    var userToken = req.get("Authorization"); // eslint-disable-line

	    var _utils$readToken = utils.readToken(userToken);

	    var username = _utils$readToken.username;
	    var expiration = _utils$readToken.expiration; // eslint-disable-line
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.gameExist = function gameExist(name) {
	    return findGameByName(name).then(function (game) {
	        return game != null;
	    });
	};
	...
	exports.createGame = function createGame(name, password) {
	    var restricted = password !== undefined;
	    var game = {
	    ...
	    if (restricted) {
	        var _password = utils.hashPassword(_password);
	        return Object.assign({ password: _password }, game);
	    } else {
	        return game;
	    }
	};
	...
	function findGameByName(name) {
	    return mongo.connect().then(function (db) {
	        return db.collection('games').findOne({ name: name }).then(mongo.close(db));
	    });
	}
	...
	exports.saveGame = function saveGame(game) {
	    return mongo.connect().then(function (db) {
	        return db.collection('games').insertOne(game).then(mongo.close(db));
	    }).then(function () {
	        return game;
	    });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var relative = __webpack_require__(22).relative
...
/***/ function(module, exports, __webpack_require__) {
	...
	lazyProperty(module.exports, 'bufferConcat', function bufferConcat() {
	  return Buffer.concat || __webpack_require__(19)
	})
	...
	lazyProperty(module.exports, 'callSiteToString', function callSiteToString() {
	  ...
	  return stack[0].toString ? toString : __webpack_require__(20)
	})

	lazyProperty(module.exports, 'eventListenerCount', function eventListenerCount() {
	  return EventEmitter.listenerCount || __webpack_require__(21)
	})
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bytes = __webpack_require__(24)
	...
	var typeis = __webpack_require__(66)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var statuses = __webpack_require__(27);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var codes = __webpack_require__(28);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var createError = __webpack_require__(26)
	var getBody = __webpack_require__(38)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var bomHandling = __webpack_require__(40),
	...
	iconv.getCodec = function getCodec(encoding) {
	    if (!iconv.encodings)
	        iconv.encodings = __webpack_require__(41); // Lazy load all encoding definitions.
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    'gbk': {
	        type: '_dbcs',
	        table: function() { return __webpack_require__(53).concat(__webpack_require__(54)) },
	    },
	    'xgbk': 'gbk',
	    ...
	    'gb18030': {
	        type: '_dbcs',
	        table: function() { return __webpack_require__(53).concat(__webpack_require__(54)) },
	        gb18030: function() { return __webpack_require__(55) },
	    },
	    ...
	    'big5hkscs': {
	        type: '_dbcs',
	        table: function() { return __webpack_require__(57).concat(__webpack_require__(58)) },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Transform = __webpack_require__(60).Transform;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var typer = __webpack_require__(67)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var extname = __webpack_require__(22).extname
